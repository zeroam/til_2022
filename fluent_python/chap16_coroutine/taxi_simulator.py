...
def taxi_process(ident, trips, start_time=0):
    """Yieid to simulator issuing event at each state change"""
...
def main(end_time=DEFAULT_END_TIME, num_taxis=DEFAULT_NUMBER_OF_TAXIS, seed=None):
    ...
    taxis = {
        i: taxi_process(i, (i + 1) * 2, i * DEPARUTRE_INTERVAL)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help=f"random generator seed (for testing)",
    )
